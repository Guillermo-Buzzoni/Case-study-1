...
Since I am doing this script from a computer with a system language different from English, I will set the locale to English to avoid confusion when displaying days of the week.

```{r setting locale to English}
